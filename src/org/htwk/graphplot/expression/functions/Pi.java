...
/**
 * Function for calculating the pi constant.
 * 
...
public class Pi extends Function {
	...
	public static final FunctionInformation functionInformation = new FunctionInformation(Pi.class, "pi", parameterCountChecker);

	public Pi(Expression[] parameters) throws InvalidFunctionParamException {
