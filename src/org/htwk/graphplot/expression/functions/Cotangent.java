...
/**
 * Function for calculating the cotangent value for an expression.
 * 
...
public class Cotangent extends Function {
	...
	public static final FunctionInformation functionInformation = new FunctionInformation(Cotangent.class, "cot", parameterCountChecker);

	private Expression param;

	public Cotangent(Expression[] parameters) throws InvalidFunctionParamException {
	...
	public double calculateValue(Map<String, Double> variables) throws InvalidVariableNameException {
		return 1 / Math.tan(param.calculateValue(variables));
	}
