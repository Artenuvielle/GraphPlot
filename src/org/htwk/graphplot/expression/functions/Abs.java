...
public class Abs extends Function {
	...
	public static final FunctionInformation functionInformation = new FunctionInformation(Abs.class, "abs", parameterCountChecker);

	private Expression param;

	public Abs(Expression[] parameters) throws InvalidFunctionParamException {
	...
	public double calculateValue(Map<String, Double> variables) throws InvalidVariableNameException {
		return Math.abs(param.calculateValue(variables));
	}
