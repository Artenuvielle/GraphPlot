...
/**
 * Function for calculating the rounded value of an expression.
 * 
...
public class Round extends Function {
	...
	public static final FunctionInformation functionInformation = new FunctionInformation(Round.class, "round", parameterCountChecker);

	private Expression param;

	public Round(Expression[] parameters) throws InvalidFunctionParamException {
	...
	public double calculateValue(Map<String, Double> variables) throws InvalidVariableNameException {
		return Math.round(param.calculateValue(variables));
	}
