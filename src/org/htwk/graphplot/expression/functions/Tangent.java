...
/**
 * Function for calculating the tangent value for an expression.
 * 
...
public class Tangent extends Function {
	...
	public static final FunctionInformation functionInformation = new FunctionInformation(Tangent.class, "tan", parameterCountChecker);

	private Expression radicand;

	public Tangent(Expression[] parameters) throws InvalidFunctionParamException {
	...
	public double calculateValue(Map<String, Double> variables) throws InvalidVariableNameException {
		return Math.tan(radicand.calculateValue(variables));
	}
