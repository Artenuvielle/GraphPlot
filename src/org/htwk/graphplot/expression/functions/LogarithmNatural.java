...
/**
 * Function for calculating the natural logarithm value for an expression.
 * 
...
public class LogarithmNatural extends Function {
	...
	public static final FunctionInformation functionInformation = new FunctionInformation(LogarithmNatural.class, "ln", parameterCountChecker);

	private Expression param;

	public LogarithmNatural(Expression[] parameters) throws InvalidFunctionParamException {
	...
	public double calculateValue(Map<String, Double> variables) throws InvalidVariableNameException {
		return Math.log(param.calculateValue(variables));
	}
