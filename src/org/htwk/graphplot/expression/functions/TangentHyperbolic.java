...
/**
 * Function for calculating the hyperbolic tangent value for an expression.
 * 
 * @author Sophie Eckenstaler, René Martin
 * @version 1.0
 */
public class TangentHyperbolic extends Function {
	...
	public static final FunctionInformation functionInformation = new FunctionInformation(TangentHyperbolic.class, "tanh", parameterCountChecker);

	private Expression param;

	public TangentHyperbolic(Expression[] parameters) throws InvalidFunctionParamException {
	...
	public double calculateValue(Map<String, Double> variables) throws InvalidVariableNameException {
		return Math.tanh(param.calculateValue(variables));
	}
