...
/**
 * Function for calculating the sine value for an expression.
 * 
...
public class Sine extends Function {
	...
	public static final FunctionInformation functionInformation = new FunctionInformation(Sine.class, "sin", parameterCountChecker);

	private Expression param;

	public Sine(Expression[] parameters) throws InvalidFunctionParamException {
	...
	public double calculateValue(Map<String, Double> variables) throws InvalidVariableNameException {
		return Math.sin(param.calculateValue(variables));
	}
