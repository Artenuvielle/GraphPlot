...
/**
 * Function for calculating the hyperbolic sine value for an expression.
 * 
 * @author Sophie Eckenstaler, René Martin
 * @version 1.0
 */
public class SineHyperbolic extends Function {
	...
	public static final FunctionInformation functionInformation = new FunctionInformation(SineHyperbolic.class, "sinh", parameterCountChecker);

	private Expression param;

	public SineHyperbolic(Expression[] parameters) throws InvalidFunctionParamException {
	...
	public double calculateValue(Map<String, Double> variables) throws InvalidVariableNameException {
		return Math.sinh(param.calculateValue(variables));
	}
