...
/**
 * Function for calculating the square root of an expression.
 * 
...
public class SquareRoot extends Function {
	...
	public static final FunctionInformation functionInformation = new FunctionInformation(SquareRoot.class, "sqrt", parameterCountChecker);
