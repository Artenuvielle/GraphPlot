...
/**
 * Function for calculating the signum value of an expression.
 * 
...
public class Signum extends Function {
	...
	public static final FunctionInformation functionInformation = new FunctionInformation(Signum.class, "sign", parameterCountChecker);

	private Expression param;

	public Signum(Expression[] parameters) throws InvalidFunctionParamException {
	...
	public double calculateValue(Map<String, Double> variables) throws InvalidVariableNameException {
		return Math.signum(param.calculateValue(variables));
	}
