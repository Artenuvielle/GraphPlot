...
/**
 * Function for calculating the cosine value for an expression.
 * 
...
public class Cosine extends Function {
	...
	public static final FunctionInformation functionInformation = new FunctionInformation(Cosine.class, "cos", parameterCountChecker);

	private Expression param;

	public Cosine(Expression[] parameters) throws InvalidFunctionParamException {
	...
	public double calculateValue(Map<String, Double> variables) throws InvalidVariableNameException {
		return Math.cos(param.calculateValue(variables));
	}
