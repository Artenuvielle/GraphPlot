...
/**
 * Function for calculating the dual logarithm value for an expression.
 * 
 * @author Sophie Eckenstaler, René Martin
 * @version 1.0
 */
public class LogarithmDual extends Function {
	...
	public static final FunctionInformation functionInformation = new FunctionInformation(LogarithmDual.class, "ld", parameterCountChecker);

	private Expression param;

	public LogarithmDual(Expression[] parameters) throws InvalidFunctionParamException {
	...
	public double calculateValue(Map<String, Double> variables) throws InvalidVariableNameException {
		return Math.log(param.calculateValue(variables)) / Math.log(2);
	}
